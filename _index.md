...
| [Nexus Group (IN Groupe)](#nexus-ingroupe)                       | Certificate Manager    | PKI              | 2024-03-13   |                  :x:                  |                :x:                 |        :x:         |         :x:         |  :clock1:   |    :clock1:    |   :clock1:    |       :x:       |         :x:         |   :x:    |        :x:         |
...
Nexus Group secures society by enabling trusted identities for people and things. Our future-proof PKI helps organizations enable trust with certificate-based identities for citizens, employees, devices, applications, things, and IoT.
Our PKI, Certificate Manager is certified Common Criteria (CC) EAL4+ and we deliver it on Premise and as Service.
Online test service available starting April 2024.
